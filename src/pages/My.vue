<template>
  <div>
    <top-banner v-once></top-banner>
    
    <group label-width="5em" v-once style="margin-top:0">
      <cell primary="content" :title="'My Favorites' | $tt('我的收藏')" is-link :disabled="true"></cell>
      <cell primary="content" :title="'My Schedule' | $tt('我的预约')" is-link :disabled="true"></cell>
    </group>
